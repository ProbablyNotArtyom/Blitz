...
define uart-load
load /home/gerg/src/arm/gerg/fetch
set $r5 = $arg0
set $pc = 0x00f00000
...
define uart-load8
load /home/gerg/src/arm/gerg/fetch8
set $r5 = 0x8000
set $pc = 0x00f00000
printf "Ready to download over serial line...\n"
end
...
load /home/gerg/new-wave.kendin/boot/boot-gdb.elf
# Bug in gdb??
...
#
define flash-burn
load /home/gerg/src/arm/gerg/lite3
set $pc = 0x00f10000
set $r1 = $arg0
set $r5 = $arg1
set $r6 = $arg1 + $arg2
