...
#define expr_trivial_usage \
	"EXPRESSION"
#ifdef __UC_LIBC__	/* Have to provide slightly modified help since we've got a crippled regexp package */
#define expr_full_usage \
	...
	"lexicographical.  Pattern matches return 1 if the match succeeded\n" \
	"or 0 if not."
#else
#define expr_full_usage \
	"Prints the value of EXPRESSION to standard output.\n\n" \
