 ...
 *	commands in the Tcl core that require DOS facilities
 *	such as files and process execution.
 *
 ...
 *
 * Copyright 2000 by procplace.com and TTC
 * Permission to use, copy, modify, and distribute this
 * software and its documentation for any purpose and without
 * fee is hereby granted, provided that this copyright
 * notice appears in all copies.  procplace.com and TTC
 * make no representations about the suitability of this
 * software for any purpose.  It is provided "as is" without
 * express or implied warranty.
 *
 * $Id: tcldosaz.c,v 1.1.1.1 2001/04/29 20:35:28 karll Exp $
 */
...
#else
	Tcl_AppendResult(interp, "no pipeline support",
		(char *) NULL);
        goto error;
#endif
    }
