 ...
 * for more details.
 *
 * RCSID $Id: state.h,v 1.56 2002/03/23 20:15:34 dhr Exp $
 */
...
struct state
{
    ...
    bool               st_pending_quick;       /* need to build IPsec SA after ISAKMP SA */
...
/* end of symmetric stuff */
    ...
    u_int32_t          st_dpd_peerseqno;       /* Last R_U_THERE received */
...
extern void state_rehash(struct connection *c);
